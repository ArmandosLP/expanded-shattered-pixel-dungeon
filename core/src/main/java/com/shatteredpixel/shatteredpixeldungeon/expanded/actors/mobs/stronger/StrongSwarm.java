...
public class StrongSwarm extends Mob {
	...
	private StrongSwarm split() {
		StrongSwarm clone = new StrongSwarm();
    ...
    public int attackProc( Char enemy, int damage ) {
        if (enemy.buff(BlobImmunity.class) == null){
            Buff.affect(enemy, SwarmPoison.class).extend(50);
        }
    ...
    public String description() {
        return Messages.get(Swarm.class, "desc") + "\n\n" + Messages.get(this, "talent");
    }
