...
public class Gruel extends Pasty {

	{
        image = ItemSpriteSheet.GRUEL;
	...
	@Override
	public void reset() {} // No special food sprites for Holiday :(
	@Override
	...
	protected void satisfy(Hero hero) {
        ...
        Buff.affect(hero, Ferocity.class).set(2 * WoodenSpoon.foodEffectAmplifier());
