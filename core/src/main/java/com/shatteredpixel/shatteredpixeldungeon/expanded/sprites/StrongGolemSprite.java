...
import com.shatteredpixel.shatteredpixeldungeon.expanded.actors.mobs.stronger.StrongGolem;
...
public class StrongGolemSprite extends MobSprite {

	private Emitter teleParticles;

	public StrongGolemSprite() {
		super();
